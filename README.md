...
```powershell
git clone https://github.com/sungbae6129/nia-slide-builder.git "$env:USERPROFILE\.codex\skills\nia-slide-builder"
...
```bash
git clone https://github.com/sungbae612/nia-slide-builder.git ~/.codex/skills/nia-slide-builder
...
https://github.com/sungbae6129/nia-slide-builder
```
