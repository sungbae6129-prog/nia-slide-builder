...
```powershell
git clone https://github.com/사용자명/nia-slide-builder.git "$env:USERPROFILE\.codex\skills\nia-slide-builder"
...
```bash
git clone https://github.com/사용자명/nia-slide-builder.git ~/.codex/skills/nia-slide-builder
...
https://github.com/사용자명/nia-slide-builder
```
